...
- MatVecs: Obtains :math:`A x` at a cost of :math:`\mathcal{O}\left(N\log{N}\right)`
- Factorization: Factors the matrix :math:`A` into the desired form at a cost of :math:`\mathcal{O}\left(N\log^2\left(N\right)\right)`
- Cholesky-like Symmetric Factorization: Obtains :math:`A = W W^T` at a cost of :math:`\mathcal{O}\left(N\log^2\left(N\right)\right)`
- Solve: Solves linear systems :math:`A x = b` at an additional cost of :math:`\mathcal{O}\left(N\log\left(N\right)\right)`
- Determinant Computation: Additional Cost of :math:`\mathcal{O}\left(N\log{N} \right)`
