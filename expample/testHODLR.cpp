...
int main(int argc, char* argv[]) {
	...
	cout << "Do you want the low rank approximation to be done using chebyshev interpolation or ACA ??" << endl;
	cout << "Enter 1 for chebyshev interpolation, 2 for ACA" << endl;
	int LowRankChoice;
	cin >> LowRankChoice;
	if (LowRankChoice != 1 && LowRankChoice != 2) {
	...
	Q->assembleMatrix(LowRankChoice);
